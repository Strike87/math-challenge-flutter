...
## Corpus Check
- 113 files · ~757,298 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1973 nodes · 2582 edges · 100 communities (84 shown, 16 thin omitted)
...
Cohesion: 0.02
Nodes (84): CustomPainter, double?, a, accuracy, actions, active, _answerController, _avatarBuilderColor (+76 more)
...
Cohesion: 0.05
Nodes (58): MathChallengeApp, _PlayerCard, SettingsService, BigEmojiOverlay, NeoButton, NeoCard, _AccessibilityPanel, AchievementsModal (+50 more)
...
### Community 19 - "State"
Cohesion: 0.16
Nodes (19): _AppShell, _AppShellState, _BossCircle, _BossCircleState, _FloatingShieldBadge, _FloatingShieldBadgeState, GameScreen, _WarningPulse (+11 more)
...
Cohesion: 0.08
Nodes (25): Color?, ../game_config.dart, build, color, desc, icon, label, locked (+17 more)
...
### Community 58 - "Persistence Schema Audit"
Cohesion: 0.29
...
- **Why does `SettingsService` connect `celebration_overlay.dart` to `game_state.dart`, `modals.dart`, `Math Challenge Flutter v1.1 Roadmap`, `game_config.dart`, `common.dart`, `StatelessWidget`, `settings.dart`, `main.dart`, `audio.dart`, `question_generator_test.dart`, `menu_screen.dart`, `State`, `Math Challenge — Complete Game Data & Behavior Reference`, `player_screen.dart`, `GameState`, `build.gradle`, `settings.gradle`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `GameState` connect `Math Challenge — Complete Game Data & Behavior Reference` to `game_state.dart`, `modals.dart`, `Math Challenge Flutter v1.1 Roadmap`, `game_config.dart`, `StatelessWidget`, `main.dart`, `question_generator_test.dart`, `menu_screen.dart`, `player_screen.dart`, `GameState`, `build.gradle`?**
