...
│   │   └── src/main/
│   │       ├── AndroidManifest.xml
│   │       ├── kotlin/com/mohamedk/mathchallenge/MainActivity.kt
...
flutter pub get
flutter create --platforms=android --org com.mohamedk --project-name math_challenge .
```
...
- **Flutter port**: A faithful 1:1 conversion preserving every gameplay
  system, mode, and UI affordance from the original HTML5 game.
