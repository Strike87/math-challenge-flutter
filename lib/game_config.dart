...
class GameConfig {
  ...
  // ─── Difficulty / phase ──────────────────────────────────────
  static const List<String> phaseKeys = [
    'easy',
    'medium',
    'hard',
    'expert',
  ...
  static const List<String> phaseNamesBanner = [
    'Easy',
    'Medium',
    'Hard',
    'Expert',
  ...
  static const List<int> phaseColors = [
    0xFF4CAF50,
    0xFFFF9800,
    0xFFF44336,
    0xFF9C27B0,
  ...
  static const List<String> survivalBosses = [
    '👹',
    '🐉',
    '🦇',
    '🐺',
  ...
  static const int survivalBossReward = 5;
  ...
  static const List<MasterLevel> masterLevels = [
    MasterLevel(
      ...
      numType: 'natural',
      story:
          "You defeated the Gorilla! The path is clear — but a wide river blocks your way.",
    ),
    MasterLevel(
      name: 'River Crossing',
      type: 'subtraction',
      ...
      numType: 'natural',
      story:
          "You crossed safely! Ahead, ancient stone ruins rise from the mist.",
    ),
    MasterLevel(
      name: 'Ancient Ruins',
      type: 'multiplication',
      ...
      numType: 'integers',
      story:
          "The Stone Guardian crumbles! You enter a dark tunnel. It's getting warmer...",
    ),
    MasterLevel(
      name: "Dragon's Cave",
      type: 'mixed',
  ...
  static const List<Achievement> achievementsDef = [
    ...
    Achievement(
        id: 'speed_demon',
        name: 'Speed Demon',
        desc: 'Answer 5 questions under 2s each',
        icon: '⚡'),
    Achievement(
        id: 'perfect_score',
        name: 'Perfect Score',
    ...
    Achievement(
        id: 'streak_master',
        name: 'Streak Master',
        desc: 'Get a 10-question streak',
        icon: '🔥'),
    Achievement(
        id: 'power_upper',
        name: 'Power Upper',
        desc: 'Use 5 power-ups in one game',
        icon: '✨'),
    Achievement(
        id: 'math_wizard',
        name: 'Math Wizard',
        desc: 'Complete Master Stage 3',
        icon: '🧙'),
    Achievement(
        id: 'persistent',
        name: 'Persistent',
    ...
    Achievement(
        id: 'quick_learner',
        name: 'Quick Learner',
        desc: 'Reach adaptive difficulty level 8',
        icon: '🚀'),
    Achievement(
        id: 'survivor',
        name: 'Survivor',
        desc: 'Score 250+ in Sudden Death mode',
        icon: '💀'),
    Achievement(
        id: 'avatar_artist',
        name: 'Avatar Artist',
        desc: 'Create a custom avatar',
        icon: '🎨'),
    Achievement(
        id: 'skill_master',
        name: 'Skill Master',
        desc: 'Reach 90% in any skill category',
        icon: '📈'),
    Achievement(
        id: 'daily_grind',
        name: 'Daily Grind',
    ...
    Achievement(
        id: 'daily_boss',
        name: 'Boss Breaker',
        desc: 'Defeat a Daily Boss',
        icon: '🐲'),
    Achievement(
        id: 'math_legend',
        name: 'Math Legend',
        desc: 'Beat all 5 Master mode stages',
        icon: '👑'),
  ];
  ...
  static const List<DailyChallenge> dailyChallenges = [
    DailyChallenge(
        id: 'blitz_15',
        title: 'Blitz Master',
        desc: 'Answer 15 questions in Blitz mode',
        reward: 50,
        type: 'blitz',
        target: 15),
    DailyChallenge(
    ...
    DailyChallenge(
        id: 'division_10',
        title: 'Division Pro',
        desc: 'Answer 10 division questions correctly',
        reward: 40,
        type: 'division',
        target: 10),
    DailyChallenge(
        id: 'master_stage',
        title: 'Stage Clear',
        desc: 'Clear any Master mode stage',
        reward: 100,
        type: 'master',
        target: 1),
    DailyChallenge(
        id: 'daily_boss',
        title: 'Boss Breaker',
        desc: "Defeat today's Daily Boss",
        reward: 75,
        type: 'dailyBoss',
        target: 1),
    DailyChallenge(
        id: 'perfect_5',
        title: 'Perfect Round',
        desc: 'Get 5 questions in a row with 100% accuracy',
        reward: 60,
        type: 'perfect',
        target: 5),
  ];
  ...
  static const int text2Light = 0xFF3D3530;
  static const int textDark = 0xFFF5F0E8;
  static const int text2Dark = 0xFFD8CFC2;
  static const int mutedLight = 0xFF7A6B5E;
  static const int mutedDark = 0xFFA89B8A;
  static const int borderLight = 0xD9FFFFFF;
  static const int borderMdLight = 0x66FFC896;
  static const int borderDark = 0x1AFFFFFF;
}
